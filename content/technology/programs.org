...
#+lastmod: 2025-10-17T19:17:47-0400
#+type: publication
...
*Pros of NixOS:*
+ Declarative setup, makes packages somewhat stable
+ Configure system in code, just like n(vim)/Emacs

*Cons of Nixos:*
+ kind of bloated
+ small security concerns, I feel like Gentoo is better with it
+ can't just run ~sudo make install~ whenever I want
+ systemd
...
** Window Manager - DWM
I have jumped between different WMs. First preconfigured dwm on arcolinux, then i3, then xmonad, and then to Luke Smith's dwm with my own configurations. +I don't see myself moving away from dwm anytime soon.+
...
*Emacs:* Emacs has a package called EMMS (Emacs Multi Media System) that I have been using since my start with DOOM Emacs. It uses MPV to play music/videos with Emacs. It's very convenient as a music player because you can create playlists with Emacs text buffers. [[/technology/emms][Here]] is a more extensive description of my multimedia workflow with Emacs.
